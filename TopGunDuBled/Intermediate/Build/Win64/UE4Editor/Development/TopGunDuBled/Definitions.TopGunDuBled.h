...
#define UE_PROJECT_NAME TopGunDuBled
#define UE_TARGET_NAME TopGunDuBledEditor
#define UE_MODULE_NAME "TopGunDuBled"
...
#define TOPGUNDUBLED_API DLLEXPORT
